            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="application.symlink.label" default="Symlink" /></td>

                            <td valign="top" class="value">${fieldValue(bean: applicationInstance, field: "symlink")}</td>
