        ...
        <div id="col_one">
          ...
          <%-- column --%>
                <div id="col_two">
                  ...
                  <g:checkBoxList name="applications" form="hostClass" from="${de.mobile.siteops.Application.list(sort:'filename')}" value="${hostClassInstance?.applications?.collect{it.id}}" optionKey="id"/>
                </div>
              </div>
          <%-- column --%>
